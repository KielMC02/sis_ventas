/*Procedimientos para Persona*/
--Listar Personas
create proc persona_listar
as
select idpersona as ID, tipo_persona as Tipo_Persona, nombre as Nombre, num_documento as Num_Documento, direccion as Direccion, telefono as Telefono, email as Email from persona
order by idpersona desc
go
--Listar Proveedores
create proc proveedores_listar
as
select idpersona as ID, tipo_persona as Tipo_Persona, nombre as Nombre, num_documento as Num_Documento, direccion as Direccion, telefono as Telefono, email as Email from persona
...
as
select idpersona as ID, tipo_persona as Tipo_Persona, nombre as Nombre, num_documento as Num_Documento, direccion as Direccion, telefono as Telefono, email as Email from persona
where nombre Like '%'+@valor+'%' or email like '%'
+@valor+'%'
order by nombre asc
go
-- Buscar Proveedores
...
as
select idpersona as ID, tipo_persona as Tipo_Persona, nombre as Nombre, num_documento as Num_Documento, direccion as Direccion, telefono as Telefono, email as Email from persona
where nombre Like '%'+@valor+'%' or email like '%' and tipo_persona = 'Proveedor'
order by idpersona desc
go
-- Buscar Clientes
...
as
select idpersona as ID, tipo_persona as Tipo_Persona, nombre as Nombre, num_documento as Num_Documento, direccion as Direccion, telefono as Telefono, email as Email from persona
where nombre Like '%'+@valor+'%' or email like '%' and tipo_persona = 'Cliente'
order by idpersona desc
go
-- B
--Insertar
